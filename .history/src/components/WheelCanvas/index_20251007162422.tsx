...
const drawWheel = (
  ...
  if (canvas?.getContext('2d')) {
    ...
    const innerHighlightBorderWidth = 12;
    const innerHighlightRadius = outsideRadius * 0.95; // Điều chỉnh vị trí border
    ...
    const innerHighlightBorderWidth2 = 12;
    const innerHighlightRadius2 = outsideRadius * 0.9; // Điều chỉnh vị trí border

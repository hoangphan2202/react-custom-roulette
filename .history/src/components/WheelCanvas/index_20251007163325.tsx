...
const drawWheel = (
  ...
  if (canvas?.getContext('2d')) {
    ...
    const innerHighlightRadius = outsideRadius * 0.9; // Điều chỉnh vị trí border
    ...
    const innerHighlightBorderWidth2 = 20;
    const innerHighlightRadius2 = outsideRadius * 0.97; // Điều chỉnh vị trí border
    ...
    const innerHighlightRadius3 = outsideRadius * 0.97; // Điều chỉnh vị trí border
    ctx.strokeStyle = '#FFFFFF66';
    ctx.lineWidth = innerHighlightBorderWidth2;
    ctx.beginPath();
    ctx.arc(centerX, centerY, innerHighlightRadius2, 0, 2 * Math.PI);

...
const rewards = [
  {
    ...
    style: {
      ...
      textColor: '#fff',
      decorativeImages: [
        { uri: '/star.svg', size: 16, opacity: 0.8 },
        { uri: '/star.svg', size: 12, opacity: 0.6 },
        { uri: '/star.svg', size: 14, opacity: 0.7 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    style: {
      ...
      decorativeImages: [
        { uri: '/star.svg', size: 16, opacity: 0.8 },
        { uri: '/star.svg', size: 13, opacity: 0.6 },
        { uri: '/star.svg', size: 14, opacity: 0.7 },
      ],
    },
  },
  ...
  },
  {
    image: { uri: '/rewards2.png' },
    style: {
      backgroundColor: 'linear-gradient(180deg, #A78BFA 0%, #8B5CF6 100%)',
      textColor: '#fff',
      decorativeImages: [
        { uri: '/star.svg', size: 16, opacity: 0.8 },
        { uri: '/star.svg', size: 14, opacity: 0.7 },
  ...
  },
  {
    image: { uri: '/rewards4.png' },
    style: {
      backgroundColor: 'linear-gradient(90deg, #F59E0B 20%, #FCD34D 80%)',
      textColor: '#fff',
      decorativeImages: [
        { uri: '/star.svg', size: 15, opacity: 0.7 },
        { uri: '/star.svg', size: 13, opacity: 0.6 },
      ],
    },
  },
  ...
  },
  {
    image: { uri: '/rewards3.png' },
    style: {
      backgroundColor: 'linear-gradient(45deg, #A78BFA 0%, #C4B5FD 100%)',
      textColor: '#fff',
      decorativeImages: [
        { uri: '/star.svg', size: 16, opacity: 0.8 },
        { uri: '/star.svg', size: 12, opacity: 0.6 },
  ...
  },
  {
    image: { uri: '/rewards.png' },
    style: {
      backgroundColor: 'linear-gradient(225deg, #60A5FA 0%, #3B82F6 100%)',
      textColor: '#fff',
      decorativeImages: [
        { uri: '/star.svg', size: 15, opacity: 0.7 },
        { uri: '/star.svg', size: 13, opacity: 0.6 },
  ...
  },
  {
    ...
    style: {
      ...
      textColor: '#fff',
      decorativeImages: [
        { uri: '/star.svg', size: 16, opacity: 0.7 },
        { uri: '/star.svg', size: 12, opacity: 0.6 },
      ],
    },
  },
  {
    image: { uri: '/rewards4.png' },
    style: {
      backgroundColor: 'linear-gradient(270deg, #38BDF8 0%, #0EA5E9 100%)',
      textColor: '#fff',
      decorativeImages: [
        { uri: '/star.svg', size: 15, opacity: 0.8 },
        { uri: '/star.svg', size: 13, opacity: 0.6 },
        { uri: '/star.svg', size: 14, opacity: 0.7 },
      ],
    },
    ...
    <div className="App">
      <header className="App-header">
        <Wheel
          ...
          backgroundColors={rewards.map(
            r => r.style.backgroundColor || '#FFA500'
          )}
          // perpendicularText
          textDistance={textDistance}
          onStopSpinning={() => {
            setMustSpin(false);
            setReward(`Reward ${prizeNumber + 1}`);
          }}
        />
